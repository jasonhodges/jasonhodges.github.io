...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">jasonhodges.codes documentation</a>
                </li>
                ...
                <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-64136643e4339972828bb3eaace7752d"' : 'data-target="#xs-components-links-module-AppModule-64136643e4339972828bb3eaace7752d"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-64136643e4339972828bb3eaace7752d"' :
                                            'id="xs-components-links-module-AppModule-64136643e4339972828bb3eaace7752d"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/ContainersModule.html" data-type="entity-link">ContainersModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ContainersModule-106bd74f86313b3ea917e9154f26a725"' : 'data-target="#xs-components-links-module-ContainersModule-106bd74f86313b3ea917e9154f26a725"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ContainersModule-106bd74f86313b3ea917e9154f26a725"' :
                                            'id="xs-components-links-module-ContainersModule-106bd74f86313b3ea917e9154f26a725"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/OtherComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">OtherComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="guards-links"' : 'id="xs-guards-links"' }>
                            <li class="link">
                                <a href="guards/PostResolverService.html" data-type="entity-link">PostResolverService</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/PostAttributes.html" data-type="entity-link">PostAttributes</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
